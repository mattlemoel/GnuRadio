...
# =============================================================================
#  kiwi_rt_868.py
#  Decodeur TEMPS REEL KIKIWI 868 MHz, directement sur RTL-SDR (variante UHF)
# -----------------------------------------------------------------------------
...
import kiwi_decoder_868 as kd  # profil AFSK Bell-202 1200/2200 Hz, 1200 bauds
...
CHAN_BW     = 15_000      # canal avant decimation (Hz) ; canalisation 25 kHz
