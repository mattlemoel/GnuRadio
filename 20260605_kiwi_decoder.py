...
# =============================================================================
#  kiwi_decoder.py
#  Decodeur de telemesure Kiwi / Kikiwi (chaine ballon / fusee CNES)
# -----------------------------------------------------------------------------
...
# =============================================================================
MARK_HZ    = 900      # tonalite (Hz) representant un bit 0  ("mark")
SPACE_HZ   = 1500     # tonalite (Hz) representant un bit 1  ("space")
BAUD       = 600      # debit symbole (bits/seconde)
FRAME_LEN  = 11       # longueur de trame en octets : FF + V1..V8 + Alim + Chk
SYNC_BYTE  = 0xFF     # octet de synchronisation en tete de trame
FULL_SCALE = 5.0      # pleine echelle en volts (5 V sur Kiwi, 3,00 V sur Kikiwi)
ADC_MAX    = 255      # valeur ADC maxi (255 = 8 bits Kiwi ; 1023 = 10 bits Kikiwi)
